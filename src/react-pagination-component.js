...
var Paginate = React.createClass({
    ...
    render: function() {
        ...
        if ( totalPage <= 1 ){
            ...
            var left = <li style={ paginationItem.num } onClick={ leftClick }>Prev</li>;
            var right = <li style={ paginationItem.num } onClick={ rightClick }>Next</li>;
        ...
        return (
            <div style={this.state.pagination} data-wow-duration="0.5s">
                <ul>
                    {left}
                    {block}
                    {right}
